...
class EvaluateFinetune(Callback):
    ...
    def __init__(self,
                 ...
                 prefix: str = 'val_',
                 **kwargs):
        super(EvaluateFinetune, self).__init__()
    ...
    def on_epoch_end(self, epoch, logs=None):
        ...
        for batch_index, batch in enumerate(self.taskloader):
            ...
            totals[self.metric_name] += categorical_accuracy(y[:,y_pred.shape[0]:], y_pred) * y_pred.shape[0]
